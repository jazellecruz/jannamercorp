  ...
  if(isset($_POST['update_sale'])){
    ...
    validate_fields($req_fields);
        if(empty($errors)){
          ...
          $sql .= " product_id= '{$p_id}',qty= qty + {$s_qty},price = price +'{$s_total}',date='{$s_date}'";
          ...
          <th> Action</th>
           ...
           <tbody  id="product_info">
              ...
              <form method="post" action="edit_sale.php?id=<?php echo (int)$sale['id']; ?>">
                ...
                <td id="s_qty">
                  <input type="text" class="form-control" name="quantity" placeholder="Add more sales">
                </td>
                <td id="s_price">
                  <input type="text" class="form-control" name="price" placeholder="<?php echo remove_junk($product['sale_price']); ?>" >
                </td>
                <td>
