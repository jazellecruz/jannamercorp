...
<div class="row" style="margin-bottom: 20px;">
    <h3 class="text-left">Products by Branches</h3>
</div>
<?php foreach($branches as $branch) : ?>
    <?php $num = 0; ?>
        <?php if ($nums % $num_of_cols == 0) : ?><div class="row"><?php endif; ?>
        <?php  $nums++; ?>
            <a href="product_by_branch.php?branch_id=<?php echo $branch['id'] ?>&branch_name=<?= $branch["name"]?>" style="color:black;">
